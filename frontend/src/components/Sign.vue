  ...
  <section class="inner-content">
    ...
    <div v-if="state.sign.vocable" class="list">
      ...
      <ul>
        <li>
          <a
            :href="`https://teckensprakskorpus.su.se/?searchterm=${state.sign.vocable}`"
            target="_blank"
    ...
    <div class="list">
      ...
      <ul>
        <li v-for="cat in state.sign.categories">
          <a
            :href="
              router.resolve({ name: 'CategoryWords', params: { id: cat.id } })
                .href
            "
            @click.prevent="
              props
                .navRouter()
                .push({ name: 'CategoryWords', params: { id: cat.id } })
            ">
            {{ cat.name }}
          </a>
        </li>
